...
# E: Configuration variables - random passwords  #
##################################################
...
##################################################
# D: Konfigurationsvariablen - externe IP        #
# E: Configuration variables - external IP       #
##################################################
...
# D: bspw. NCRELEASE="nextcloud-25.0.7.tar.bz2"
...
apt remove --purge --allow-change-held-packages -y nginx-common nginx-* nginx* php* mariadb-* mysql-common libdbd-mariadb-perl galera-* postgresql-* redis* fail2ban ufw
